...
class TestAuthSettings:
    ...
    def test_secret_key_autogenerated_in_dev(self):
        """Test insecure key auto-generates a runtime key in dev."""
        settings = AuthSettings(secret_key="change-me-in-production")
        # Validator replaces the insecure value with a generated key
        assert settings.secret_key != "change-me-in-production"
        assert len(settings.secret_key) > 20

    def test_secret_key_rejected_in_production(self):
        """Test insecure key raises ValueError in production."""
        import pytest
